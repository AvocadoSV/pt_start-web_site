...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12">
                <form method="POST" action="profile.php" class="form-container" enctype="multipart/form-data" name="upload">
...
if (isset($_POST['submit'])){
    ...
    {
        if ((($_FILES["file"]["type"] == "image/gif") || ($_FILES["file"]["type"] == "image/jpeg") || ($_FILES["file"]["type"] == "image.jpg") || ($_FILES["file"]["type"] == "image/pjpeg") || ($_FILES["file"]["type"] == "image/x-png") || ($_FILES["file"]["type"] == "image/png")) && ($_FILES["file"]["size"] < 5242880))
        {
